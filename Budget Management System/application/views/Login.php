          ...
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left p-5">
              <div class="brand-logo">
                  <h3 class="text-center text-danger">Expense Management</h3>
              </div>
             ...
             <?php echo form_error('email','<span class="help-block text-warning" >','</span>'); ?>
              <form class="pt-3" action="<?php echo base_url() ?>Users/login" method="post">
                ...
                <div class="mt-3">
                    <input type="submit" name="loginSubmit" value="Login" class="btn btn-block btn-gradient-success btn-lg font-weight-medium auth-form-btn">
                </div>
