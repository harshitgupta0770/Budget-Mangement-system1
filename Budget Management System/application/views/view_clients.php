            ...
            <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                    ...
                    <br>
                  <h2 class="card-title text-primary">Recipient Management</h2>
...
<a class="btn btn-danger btn-sm" href="<?php echo  base_url() ?>Home/view_clients?del=<?php echo $row->id ?>" onclick="return confirm('Are you sure you want to delete this Recipient?');" aria-label="Delete">
