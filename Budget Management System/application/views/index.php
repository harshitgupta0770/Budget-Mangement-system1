               ...
               foreach($expense->result() as $row)  
                {  
                 ...
                 <?php }    
                  ...
                  <h1 class="mb-5">Rs. <?php echo  $row->E ?></h1>
                  <?php }?>
               ...
               foreach($income->result() as $row)  
                {  
                 ...
                 <?php }    
                  ...
                  <h1 class="mb-5">Rs. <?php echo  $row->I ?></h1>
                  <?php }?>
         ...
         {  
           ...
           ?> 
                        <tr>
                            <td><?php echo $i++ ?></td>
                          <td>
                            <img src="<?php echo base_url() ?>assets/images/faces/user-i.png" class="mr-2" alt="image">
                           <?php echo $row->name ?>
                          </td>
                          ...
                          <a class="btn btn-danger btn-sm" href="<?php echo base_url() ?>/Home/add_debit?del=<?php echo $row->deb_id ?>"  aria-label="Delete" onclick="return confirm('Are you sure you want to delete this?');">
                ...
                {  
                  ...
                  ?> 
                        <tr>
                          ...
                          <td>
                            <label class="badge badge-gradient-success">Income</label>
                          </td>
                           <td>
