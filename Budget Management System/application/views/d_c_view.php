...
<div class="tab">
  <button class="tablinkss " onclick="openCityy(event, 'debit')" id="defaultOpen">Expenses</button>
...
//                       $sum_texte .= " Excess Amount ";
 ...
 elseif($sum===0) {
     $sum_text="Hurray!!......No Dues!";
           ...
           ?> 
                    <h5 class="text-success">Expenses:Rs. <?php echo $row->dtotal ?></h5>
                    <h5 class="text-success">Amount Recieved:Rs. <?php echo $row->ctotal ?></h5>
                    <h5 class="text-danger">Due's Amount: Rs. <?php echo $sum_text?>/-</h5>
                     <h5 class="text-warning">Excess Amount: Rs. <?php echo $sum_texte?>/-</h5>
                    <?php       
             }  
          }  
          else  
